...
export default defineEventHandler(() => {
  return {
    ...
    skills: [
      {
        name: 'Angular (v8-v21)',
        iconPath: 'M12 2.5l-9.5 3.5 1.5 11.5L12 22l8-4.5 1.5-11.5L12 2.5z M12 6l-4.5 10 M12 6l4.5 10 M8.5 13.5h7'
      },
      ...
      },
      {
        ...
        iconPath: 'M15 15l-6 6m0-6l6 6M9 9V3m0 6h6m-6 0H3m6 0v6m0-6H9m0 6H3m0 0v6m6-6v6m6-6v6m0-6h6m-6 0V3'
      },
      ...
      {
        name: 'Performance',
        iconPath: 'M12 6V3m0 18v-3m6.36-11.64l-2.12 2.12M7.76 16.24l-2.12 2.12M21 12h-3m-15 0H3m11.64-6.36l2.12-2.12M7.76 7.76l2.12-2.12'
      },
