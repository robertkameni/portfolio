    ...
    @if (isDevMode) {
      <dev-proxy-bar>
        ...
        <button
          ...
          class="w-full sm:w-auto text-xs px-4 py-1.5 bg-blue-950/30 hover:bg-blue-900/50 text-blue-400 border border-blue-900/50 rounded-full transition-colors duration-700 whitespace-nowrap cursor-pointer"
        >
          Recruiter
        </button>
        <button
          (click)="setMockProfile('developer')"
          class="text-xs px-4 py-1.5 bg-purple-950/30 hover:bg-purple-900/50 text-purple-400 border border-purple-900/50 rounded-full transition-colors duration-700 whitespace-nowrap cursor-pointer w-full sm:w-auto"
        >
          Developer
        </button>
        ...
        <button
          ...
          class="w-full sm:w-auto text-xs px-4 py-1.5 bg-gray-900/50 hover:bg-gray-800 text-gray-400 border border-gray-800 rounded-full transition-colors duration-700 whitespace-nowrap cursor-pointer"
        >
          Reset
        </button>
        ...
        <div class="w-full sm:w-auto sm:ml-auto">
          @if (auth.authInitialized() && auth.isAuthenticated() && auth.isAdmin()) {
            <button
              ...
              class="w-full sm:w-auto cursor-pointer inline-flex items-center justify-center sm:justify-start gap-2 px-3 py-1.5 bg-primary text-black rounded-md shadow hover:bg-[#16a34a] transition-colors duration-300 font-semibold"
            >
            ...
            <button
              ...
              class="w-full sm:w-auto cursor-pointer inline-flex items-center justify-center sm:justify-start gap-2 px-3 py-1.5 bg-green-600 text-white rounded-md shadow hover:bg-green-500 transition-colors duration-300"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path
                  d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10zM4 20v-1a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v1"
