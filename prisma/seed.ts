...
const profileData = {
  ...
  intro: {
    ...
    socials: [
      { platform: 'LinkedIn', url: 'https://www.linkedin.com/in/robertkameni/', iconPath: 'M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z' },
      { platform: 'Xing', url: 'https://www.xing.com/profile/Robert_Kameni', iconPath: 'M18.188 0H5.812C2.602 0 0 2.602 0 5.812v12.376C0 21.398 2.602 24 5.812 24h12.376C21.398 24 24 21.398 24 18.188V5.812C24 2.602 21.398 0 18.188 0zM7.6 7.2h3.2l2.4 4.2-3.8 6.6H6.2l3.8-6.6L7.6 7.2zm6.6-3.2h3.2l-5.8 10 3.6 6h-3.2l-3.6-6 5.8-10z' },
    ],
  },
  heroCards: [
    {
