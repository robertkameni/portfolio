...
- **Framework:** Angular 20 (Signals, Standalone Components, Directives)
...
- **AI-Powered Analytics:** In-depth visitor tracking and analysis using a custom-built AI engine with Google Gemini.
